...
import { Bed, Bath, Home, Tag, Wind, Mountain, MapPin, ChevronLeft, ChevronRight, X, MessageCircle, Mail, Phone, Flame, Car, Waves, Wifi, DoorOpen, TreePine, Maximize, Armchair } from "lucide-react";

const WHATSAPP_LINKS = {
  es: "https://wa.me/34662317561?text=Hola%20Manuel%2C%20me%20interesa%20la%20villa%20en%20Frigiliana%20(ref.%20pa226).%20%C2%BFPuedo%20agendar%20una%20visita%3F",
  en: "https://wa.me/34662317561?text=Hi%20Manuel%2C%20I%27m%20interested%20in%20the%20villa%20in%20Frigiliana%20(ref.%20pa226).%20Can%20I%20schedule%20a%20viewing%3F",
};

const PHOTOS = Array.from({ length: 17 }, (_, i) =>
  `/images/properties/villa-celia-${String(i + 1).padStart(2, "0")}.jpg`
);

const t = {
  es: {
    title: "Villa en Frigiliana — 2.500€/mes | Propaxar",
    metaDesc: "Villa de 5 dormitorios en Frigiliana con acceso asfaltado, piscina privada vallada, vistas 360° al mar y montaña. 2.500€/mes. Ref. pa226.",
    ref: "Ref. pa226 · Alquiler residencial",
    heading: "Villa en Frigiliana",
    subtitle: "Espacio, vistas y acceso impecable",
    ...
    featuresList: [
      ...
      { icon: Home, label: "Espacio oficina en casa" },
      { icon: Car, label: "Garaje" },
      ...
      { icon: Maximize, label: "Vivienda amplia" },
      { icon: Wifi, label: "WiFi" },
    ],
    description: "Descripción",
    descIntro: <>¿Buscas la paz del campo sin las complicaciones de los carriles de tierra? Situada estratégicamente en la carretera que une Frigiliana con Torrox, esta propiedad ofrece la combinación perfecta: <strong>privacidad absoluta, acceso impecable por asfalto y una panorámica que quita el aliento.</strong></>,
    descP1: <>Pocas villas en esta zona ofrecen esta facilidad de llegada (a solo 7 minutos del centro de Frigiliana) manteniendo esa sensación de desconexión total.</>,
    descSubtitle: "La Casa: Espacio para Todos",
    descBullets: [
      { title: "Dos Salones Independientes", text: <>Espacios amplios y luminosos para que cada uno encuentre su rincón de relax.</> },
      { title: "5 Dormitorios y 2 Baños", text: <>Capacidad de sobra sin renunciar a la intimidad.</> },
      { title: "Cocina Equipada", text: <>Lista para preparar esas cenas locales con productos de la zona.</> },
    ],
    descSubtitle2: "El Exterior: Donde Sucede la Magia",
    descBullets2: [
      { title: "Vistas de 360°", text: <>Desde su terraza privada en la azotea, tus ojos viajarán desde las cumbres de la <strong>Sierra de Almijara</strong> hasta el azul del <strong>Mediterráneo en Nerja</strong>.</> },
      { title: "Piscina con Seguridad", text: <>Una gran piscina privada <strong>totalmente vallada</strong> para que los niños disfruten con total tranquilidad para los padres.</> },
      { title: "Zona de Barbacoa y Porche", text: <>El lugar ideal para cenas al fresco bajo la sombra, con el campo como único testigo.</> },
    ],
    descNote: <>«Lo que diferencia a esta propiedad es su combinación de espacio, accesibilidad y vistas. Es una de las pocas villas de 5 dormitorios en Frigiliana con acceso 100% asfaltado y piscina vallada. Para familias que necesitan espacio real, esta es la opción.»</>,
    ...
    highlightsList: [
      ...
      "5 dormitorios, 2 baños, 150m²",
      "Vistas 360° mar y montaña",
      "Piscina privada vallada",
      "Dos salones independientes",
      "Garaje y parking privado",
      "Chimenea y aire acondicionado",
      "A 7 min de Frigiliana · WiFi incluido",
    ],
    address: "Frigiliana, Málaga 29788",
    langToggle: "EN",
  },
  en: {
    title: "Villa in Frigiliana — €2,500/month | Propaxar",
    metaDesc: "5-bedroom villa in Frigiliana with asphalted access, fenced private pool, 360° sea and mountain views. €2,500/month. Ref. pa226.",
    ref: "Ref. pa226 · Residential rental",
    heading: "Villa in Frigiliana",
    subtitle: "Space, views & impeccable access",
    location: "Frigiliana, Málaga",
    perMonth: "/month",
    type: "Type",
    typeValue: "Villa",
    ...
    featuresList: [
      ...
      { icon: Flame, label: "BBQ" },
      { icon: MapPin, label: "Near local services" },
      ...
      { icon: Maximize, label: "Spacious home" },
      { icon: Wifi, label: "WiFi" },
    ],
    description: "Description",
    descIntro: <>Looking for countryside peace without the complications of dirt tracks? Strategically situated on the road linking Frigiliana to Torrox, this property offers the perfect combination: <strong>absolute privacy, impeccable asphalted access and breathtaking panoramic views.</strong></>,
    descP1: <>Few villas in this area offer this ease of access (just 7 minutes from Frigiliana town centre) while maintaining that feeling of total disconnection.</>,
    descSubtitle: "The House: Space for Everyone",
    descBullets: [
      { title: "Two Independent Living Rooms", text: <>Bright, spacious areas so everyone can find their own corner to relax.</> },
      { title: "5 Bedrooms and 2 Bathrooms", text: <>More than enough capacity without sacrificing privacy.</> },
      { title: "Fully Equipped Kitchen", text: <>Ready for preparing local dinners with fresh produce from the area.</> },
    ],
    descSubtitle2: "The Exterior: Where the Magic Happens",
    descBullets2: [
      { title: "360° Views", text: <>From the private rooftop terrace, your eyes will travel from the peaks of the <strong>Sierra de Almijara</strong> to the blue of the <strong>Mediterranean in Nerja</strong>.</> },
      { title: "Pool with Security", text: <>A large private pool <strong>fully fenced</strong> so children can enjoy with complete peace of mind for parents.</> },
      { title: "BBQ & Porch Area", text: <>The ideal spot for al fresco dinners in the shade, with the countryside as your only witness.</> },
    ],
    descNote: <>"What sets this property apart is its combination of space, accessibility and views. It's one of the few 5-bedroom villas in Frigiliana with 100% asphalted access and a fenced pool. For families that need real space, this is the option."</>,
    ...
    highlightsList: [
      "100% asphalted access",
      "5 bedrooms, 2 bathrooms, 150m²",
      "360° sea and mountain views",
      "Fenced private pool",
      "Two independent living rooms",
      "Garage and private parking",
      "Fireplace and air conditioning",
      "7 min from Frigiliana · WiFi included",
    ],
    address: "Frigiliana, Málaga 29788",
    langToggle: "ES",
  },
...
const MAPS_URL = "https://www.google.com/maps/place/R33J%2BM64+Frigiliana,+M%C3%A1laga";
const MAPS_EMBED = "https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3197.5!2d-3.8830!3d36.7960!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0xd7224c1a4f6e8c1%3A0xabcdef1234567890!2sR33J%2BM64%20Frigiliana%2C%20M%C3%A1laga!5e1!3m2!1ses!2ses!4v1772797075045!5m2!1ses!2ses";
          ...
          <div className="relative max-w-5xl mx-auto px-6 pt-12 pb-16">
            ...
            <div className="flex flex-col md:flex-row md:items-end md:justify-between gap-4 mb-8">
              ...
              <div className="text-right">
                <div className="text-white font-black" style={{ fontSize: 'clamp(2rem, 5vw, 3rem)' }}>2.500€</div>
            ...
            <div className="lg:col-span-2 space-y-6">
              ...
              <div className="rounded-lg overflow-hidden" style={cardStyle}>
                ...
                <div className="px-6 py-5 grid grid-cols-5 gap-4">
                  {[
                    ...
                    { icon: Bed, label: c.bedrooms, value: "5" },
                    { icon: Bath, label: c.bathrooms, value: "2" },
                    { icon: Home, label: c.size, value: "150m²" },
                    { icon: Tag, label: c.reference, value: "pa226" },
                  ].map((stat, i) => (
              ...
              <div className="rounded-lg overflow-hidden" style={cardStyle}>
                ...
                <div className="px-6 py-5 space-y-4 text-sm leading-relaxed" style={{ color: '#444' }}>
                  ...
                  <h3 className="font-black text-base mt-6 mb-3" style={{ color: '#2d3e4e' }}>{c.descSubtitle2}</h3>
                  <ul className="space-y-4">
                    {c.descBullets2.map((b, i) => (
                      <li key={i}>
                        <strong style={{ color: '#1a1a1a' }}>{b.title}:</strong>{' '}
                        <span style={{ color: '#666' }}>{b.text}</span>
                      </li>
              ...
              <div className="sticky top-20 space-y-4">
                ...
                <div className="rounded-lg overflow-hidden text-white" style={{ background: 'linear-gradient(135deg, #2d3e4e 0%, #3d5a73 100%)' }}>
                  <div className="px-6 py-6 text-center">
                    <div className="font-black text-4xl mb-1">2.500€</div>
                  ...
                  <div className="px-6 pb-6 space-y-3">
                    ...
                    <a
                      href="mailto:info@propaxar.com?subject=Consulta%20Villa%20Frigiliana%20pa226"
