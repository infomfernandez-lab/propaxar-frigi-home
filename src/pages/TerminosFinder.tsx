    ...
    <div className="min-h-screen bg-[#f5f5f5] py-5 px-5" style={{ fontFamily: "-apple-system, BlinkMacSystemFont, 'Segoe UI', sans-serif" }}>
      <div className="max-w-[900px] mx-auto">
        ...
        <div className="flex gap-4 mb-4 text-sm">
          <a href="https://propaxar.es" className="text-[#2c5282] hover:underline">← Volver a Propaxar.es</a>
          <a href="/finder" className="text-[#2c5282] hover:underline">← Volver a Property Finder</a>
        </div>
        ...
        <div className="bg-white p-8 md:p-[60px] rounded-lg shadow-md">
          ...
          <ul className="list-disc ml-8 mb-5 space-y-2">
            ...
            <li><strong>Selección personalizada:</strong> Búsqueda y preselección de propiedades disponibles en el mercado que cumplan razonablemente con los criterios específicos del cliente. El número de propiedades disponibles dependerá de las condiciones del mercado en el momento de la búsqueda.</li>
          ...
          <div className="bg-[#f0f9ff] border-2 border-[#3b82f6] p-6 my-8 rounded-lg">
            ...
            <ul className="list-disc ml-8 mb-4 space-y-1">
              ...
              <li><strong>NO REEMBOLSABLE</strong> excepto en el caso específico descrito en la sección 3.3</li>
            ...
            <ul className="list-disc ml-8 space-y-1">
              ...
              <li>Si alquila propiedad gestionada por Propaxar: <strong>€0</strong> (reembolso completo de €180) ✅</li>
            </ul>
          </div>
          ...
          <p className="mb-4 text-justify">El pago inicial de €180 es NO REEMBOLSABLE bajo ninguna circunstancia (excepto lo dispuesto en la sección 3.3), incluyendo pero no limitado a:</p>
          <ul className="list-disc ml-8 mb-5 space-y-2">
          ...
          <div className="bg-[#f0fff4] border-2 border-[#48bb78] p-6 my-8 rounded-lg">
            <h3 className="text-lg font-bold text-[#276749] mt-0 mb-4">3.3. EXCEPCIÓN: Reembolso por Alquiler de Propiedad Gestionada Directamente por Propaxar</h3>
            <p className="mb-4 text-justify">Si el cliente decide alquilar una propiedad que es gestionada DIRECTAMENTE por Propaxar, el prestador reembolsará la totalidad de los €180 al cliente.</p>
            <p className="mb-2">En este caso:</p>
            <ul className="list-disc ml-8 mb-4 space-y-2">
              <li>El cliente NO pagará los €220 adicionales</li>
              <li>El cliente recibirá reembolso completo de €180</li>
              <li>Coste total del servicio: <strong>€0 (GRATIS)</strong></li>
            </ul>
            <p className="mb-2 font-bold">¿Qué son propiedades gestionadas directamente?</p>
            <p className="mb-4 text-justify">Son aquellas en las que Propaxar tiene relación contractual directa con el propietario y gestiona el alquiler sin intermediarios.</p>
            <p>El prestador identificará estas propiedades con el distintivo <strong>🏠 PROPAXAR DIRECT</strong></p>
          </div>
          ...
          <ol className="list-decimal ml-8 mb-5 space-y-2">
            ...
            <li>La propiedad es de un tercero (NO gestionada directamente por Propaxar)</li>
          </ol>
          <div className="bg-[#fffbeb] border-l-4 border-[#ffd700] p-5 my-6">
            <p><strong className="text-[#d97706]">IMPORTANTE:</strong> Si la propiedad alquilada es gestionada directamente por Propaxar, NO se exige este pago de €220 y se reembolsa el pago inicial de €180.</p>
          </div>
          ...
          <ol className="list-decimal ml-8 mb-5 space-y-2">
            ...
            <li>Presentar al cliente las propiedades disponibles en el mercado que cumplan razonablemente con los criterios especificados. El prestador no garantiza un número mínimo de propiedades disponibles, ya que esto depende de las condiciones del mercado.</li>
          ...
          {/* 6. IDENTIFICACIÓN PROPIEDADES - NEW */}
          <h2 className="text-2xl text-[#2c5282] mt-10 mb-5 pb-2 border-b-2 border-[#e2e8f0]">6. IDENTIFICACIÓN DE PROPIEDADES GESTIONADAS DIRECTAMENTE</h2>
          <p className="mb-4">Durante la presentación de propiedades, el prestador identificará claramente:</p>
          <div className="bg-[#f0fff4] border-2 border-[#48bb78] p-5 my-4 rounded-lg">
            <p className="mb-2"><strong>🏠 Gestionadas directamente por Propaxar:</strong> Marcadas "PROPAXAR DIRECT" — Sin coste adicional (reembolso €180)</p>
          </div>
          <div className="bg-[#f0f9ff] border-2 border-[#3b82f6] p-5 my-4 rounded-lg">
            <p><strong>🏢 Propiedades de terceros:</strong> Gestionadas por otras agencias — €220 adicionales (€400 total)</p>
          </div>

          {/* 7. OBLIGACIONES CLIENTE (was 6) */}
          <h2 className="text-2xl text-[#2c5282] mt-10 mb-5 pb-2 border-b-2 border-[#e2e8f0]">7. OBLIGACIONES DEL CLIENTE</h2>
          ...
          <ol className="list-decimal ml-8 mb-5 space-y-2">
            ...
            <li>Realizar el pago final de €220 en caso de alquilar una propiedad de terceros presentada por el prestador</li>
          ...
          <div className="bg-[#fffbeb] border-l-4 border-[#ffd700] p-5 my-6">
            <h3 className="text-lg font-bold text-[#2c5282] mt-0 mb-3">7.1. Cláusula Anti-Elusión</h3>
          ...
          {/* 8. DURACIÓN (was 7) */}
          <h2 className="text-2xl text-[#2c5282] mt-10 mb-5 pb-2 border-b-2 border-[#e2e8f0]">8. DURACIÓN DEL SERVICIO</h2>
          ...
          {/* 9. LIMITACIÓN (was 8) */}
          <h2 className="text-2xl text-[#2c5282] mt-10 mb-5 pb-2 border-b-2 border-[#e2e8f0]">9. LIMITACIÓN DE RESPONSABILIDAD</h2>

          <h3 className="text-lg text-[#2c5282] mt-8 mb-4">9.1. Disponibilidad de Propiedades</h3>
          ...
          <h3 className="text-lg text-[#2c5282] mt-8 mb-4">9.2. Información de Terceros</h3>
          ...
          <h3 className="text-lg text-[#2c5282] mt-8 mb-4">9.3. Decisión Final</h3>
          ...
          <h3 className="text-lg text-[#2c5282] mt-8 mb-4">9.4. Exclusión de Responsabilidad</h3>
          ...
          {/* 10. RGPD (was 9) */}
          <h2 className="text-2xl text-[#2c5282] mt-10 mb-5 pb-2 border-b-2 border-[#e2e8f0]">10. PROTECCIÓN DE DATOS PERSONALES (RGPD)</h2>

          <h3 className="text-lg text-[#2c5282] mt-8 mb-4">10.1. Responsable del Tratamiento</h3>
          ...
          <h3 className="text-lg text-[#2c5282] mt-8 mb-4">10.2. Finalidad del Tratamiento</h3>
          ...
          <h3 className="text-lg text-[#2c5282] mt-8 mb-4">10.3. Conservación de Datos</h3>
          ...
          <h3 className="text-lg text-[#2c5282] mt-8 mb-4">10.4. Derechos del Cliente</h3>
          ...
          {/* 11. DESISTIMIENTO (was 10) */}
          <h2 className="text-2xl text-[#2c5282] mt-10 mb-5 pb-2 border-b-2 border-[#e2e8f0]">11. DERECHO DE DESISTIMIENTO</h2>
          ...
          {/* 12-13 (was 11-12) */}
          <h2 className="text-2xl text-[#2c5282] mt-10 mb-5 pb-2 border-b-2 border-[#e2e8f0]">12. MODIFICACIÓN DE LOS TÉRMINOS</h2>
          ...
          <h2 className="text-2xl text-[#2c5282] mt-10 mb-5 pb-2 border-b-2 border-[#e2e8f0]">13. NULIDAD PARCIAL</h2>
          ...
          {/* 14. LEY (was 13) */}
          <h2 className="text-2xl text-[#2c5282] mt-10 mb-5 pb-2 border-b-2 border-[#e2e8f0]">14. LEY APLICABLE Y JURISDICCIÓN</h2>

          <h3 className="text-lg text-[#2c5282] mt-8 mb-4">14.1. Ley Aplicable</h3>
          ...
          <h3 className="text-lg text-[#2c5282] mt-8 mb-4">14.2. Jurisdicción</h3>
          ...
          {/* 15. ACEPTACIÓN (was 14) */}
          <h2 className="text-2xl text-[#2c5282] mt-10 mb-5 pb-2 border-b-2 border-[#e2e8f0]">15. ACEPTACIÓN ELECTRÓNICA</h2>
          <div className="bg-[#fffbeb] border-l-4 border-[#ffd700] p-5 my-6">
            ...
            <ol className="list-decimal ml-8 mb-4 space-y-2">
              ...
              <li>Acepta expresamente que el pago inicial de €180 es NO REEMBOLSABLE (salvo lo previsto en la sección 3.3)</li>
          ...
          {/* 16. REGISTRO (was 15) */}
          <h2 className="text-2xl text-[#2c5282] mt-10 mb-5 pb-2 border-b-2 border-[#e2e8f0]">16. REGISTRO DE LA ACEPTACIÓN</h2>
          ...
          {/* 17. CONTACTO (was 16) */}
          <h2 className="text-2xl text-[#2c5282] mt-10 mb-5 pb-2 border-b-2 border-[#e2e8f0]">17. CONTACTO</h2>
